...
#x <- build_cube_WV2(site_name = "WV2e")

x <- rast("data_out/WV2e/WV2e_stack.tif") #access the intermediate layer

v <- build_ml_df_WV2e(cube = x,
                 site_name = "WV2e",
                 df_type="grid")

#v <- "data_out/WV2e/WV2eML_in_grid_level.rds"
v
#================ ML pipeline ================
# Auto ML ------------------

task <- build_task(v, site_name="WV2e")
...
writeRaster(mod.pred.fac, filename = paste0("data_out/",site_name,"/",site_name,"_Predict_Map_30_99_simple_simple.tif"), overwrite=TRUE)
...
write.xlsx(res.preds, paste0("data_out/Confusion/res.preds_svm_30_99_simple_",site_name,".xlsx"), rowNames=FALSE)
...
write.xlsx(b, paste0("data_out/Bench/MLR_bench_results_30_99_simple_",site_name,".xlsx"), rowNames=FALSE)


#Exporting benchmark plot
ggsave(
  p2,
  filename = paste0("data_out/Figures/benchmark_30_99_simple_",site_name,"_model_classif_ac.png"),
  width =16,
  height = 8,
  units = "cm"
)
...
ggsave(
  p3,
  filename = paste0("data_out/Figures/Final_",site_name,"_model_classif_ac_30_99_simple.png"),
  width =16,
  height = 8,
  units = "cm"
)
