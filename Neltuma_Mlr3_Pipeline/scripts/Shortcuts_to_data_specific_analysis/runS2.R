...
x <- build_cube_S2(site_name = "S2")

#x <- rast("data_out/S2/S2_stack.tif") #access the intermediate layer

v <- build_ml_df_S2(cube = x,
                      site_name = "S2",
                      df_type="grid")

#v <- "data_out/S2/S2ML_in_grid_level.rds"
v
#================ ML pipeline ================
# Auto ML ------------------

task <- build_task(v, site_name="S2")
...
writeRaster(mod.pred.fac, filename = paste0("data_out/",site_name,"/",site_name,"_Predict_Map_60_65.tif"), overwrite=TRUE)
...
write.xlsx(res.preds, paste0("data_out/Confusion/res.preds_svm_points_",site_name,"_60_65.xlsx"), rowNames=FALSE)
...
write.xlsx(b, paste0("data_out/Bench/MLR_bench_results_",site_name,"_60_65.xlsx"), rowNames=FALSE)


#Exporting benchmark plot
ggsave(
  p2,
  filename = paste0("data_out/Figures/benchmark_",site_name,"_model_classif_ac_60_65.png"),
  width =16,
  height = 8,
  units = "cm"
)
...
ggsave(
  p3,
  filename = paste0("data_out/Figures/Final_",site_name,"_model_classif_ac_60_65.png"),
  width =16,
  height = 8,
  units = "cm"
)
