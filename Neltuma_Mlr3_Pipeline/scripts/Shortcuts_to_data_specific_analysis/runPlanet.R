...
site_name = "Boravast_2022_09"

#============ Data Prep =====================

#x <- build_cube_Planet(site_name = "Boravast_2022_09")

x <- rast("data_out/Boravast_2022_09/Boravast_2022_09_stack.tif") #access the intermediate layer

v <- build_ml_df_Planet_e(cube = x,
                      site_name = "Boravast_2022_09",
                      df_type="grid")

#v <- "data_out/Boravast_2022_09/Boravast_2022_09ML_in_grid_level.rds"
v
#================ ML pipeline ================
# Auto ML ------------------

task <- build_task(v, site_name="Boravast_2022_09")
...
writeRaster(mod.pred.fac, filename = paste0("data_out/",site_name,"/",site_name,"_Predict_Map_400_85.tif"), overwrite=TRUE)
...
write.xlsx(res.preds, paste0("data_out/Confusion/res.preds_svm_points_",site_name,"_400_85.xlsx"), rowNames=FALSE)
...
write.xlsx(b, paste0("data_out/Bench/MLR_bench_results_",site_name,"_400_85.xlsx"), rowNames=FALSE)


#Exporting benchmark plot
ggsave(
  p2,
  filename = paste0("data_out/Figures/benchmark_",site_name,"_model_classif_ac_400_85.png"),
  width =16,
  height = 8,
  units = "cm"
)
...
ggsave(
  p3,
  filename = paste0("data_out/Figures/Final_",site_name,"_model_classif_ac_400_85.png"),
  width =16,
  height = 8,
  units = "cm"
)
