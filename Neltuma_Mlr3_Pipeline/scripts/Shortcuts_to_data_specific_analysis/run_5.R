...
x <- build_cube_5(site_name = "Bokspits_2")
...
write.xlsx(res.preds, paste0("data_out/Confusion/res.preds_svm_",site_name,"_5.xlsx"), rowNames=FALSE)
...
write.xlsx(b, paste0("data_out/Bench/MLR_bench_results_",site_name,"_5.xlsx"), rowNames=FALSE)


#Exporting benchmark plot
ggsave(
  p2,
  filename = paste0("data_out/Figures/benchmark_",site_name,"_model_classif_ac_5.png"),
  width =16,
  height = 8,
  units = "cm"
)
...
ggsave(
  p3,
  filename = paste0("data_out/Figures/Final_",site_name,"_model_classif_ac_5.png"),
  width =16,
  height = 8,
  units = "cm"
)
