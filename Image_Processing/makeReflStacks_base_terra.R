#Make rast reflectance stacks from Botswana/Pix4d outputs
...
writeRaster(Bokspits_1_ReflStackCrop,"E:/Glenn/Botswana/ReflStacks/Bokspits_1_Refl_StackCrop.tif", overwrite=TRUE)
...
plot(Bokspits_2_ReflStackCrop)
#write tif files

#writeRaster(Bokspits_2_ReflStack,"E:/Glenn/Botswana/ReflStacks/Bokspits_2_Refl_Stack.tif")
writeRaster(Bokspits_2_ReflStackCrop,"E:/Glenn/Botswana/ReflStacks/Bokspits_2_Refl_StackCrop.tif", overwrite=TRUE)
...
writeRaster(Bokspits_3_ReflStackCrop,"E:/Glenn/Botswana/ReflStacks/Bokspits_3_Refl_StackCrop.tif", overwrite=TRUE)
...
writeRaster(Struizendam_1_ReflStackCrop,"E:/Glenn/Botswana/ReflStacks/Struizendam_1_Refl_StackCrop.tif", overwrite=TRUE)
...
writeRaster(Struizendam_2_ReflStackCrop,"E:/Glenn/Botswana/ReflStacks/Struizendam_2_Refl_StackCrop.tif", overwrite=TRUE)
...
writeRaster(Struizendam_3_ReflStackCrop,"E:/Glenn/Botswana/ReflStacks/Struizendam_3_Refl_StackCrop.tif", overwrite=TRUE)
...
writeRaster(Struizendam_4_ReflStackCrop,"E:/Glenn/Botswana/ReflStacks/Struizendam_4_Refl_StackCrop.tif", overwrite=TRUE)