...
Bokspits_1_Planet_grid_SF <- read_sf(dsn = 'E:/Glenn/Botswana/Satellite_Data/Planet/Planet_Grids', layer = "Bokspits_1_Planet_grid")
...
Bokspits_1_WV2_Extract <- exact_extract(Bokspits_1_Predict,Bokspits_1_Planet_grid_SF,"mode")
names(Bokspits_1_WV2_Extract) <- c('mode')
Bokspits_1_WV2_Extract_DF <-bind_cols(Bokspits_1_Planet_grid_SF,Bokspits_1_WV2_Extract)

Bokspits_1_WV2_Extract <- exact_extract(Bokspits_1_Predict,Bokspits_1_Planet_grid_SF,"majority" )
...
Bokspits_1_WV2_Extract <- exact_extract(Bokspits_1_Predict,Bokspits_1_Planet_grid_SF,"frac" )# calculates fraction cover for each classification value
...
Bokspits_2_Planet_grid_SF <- read_sf(dsn = 'E:/Glenn/Botswana/Satellite_Data/Planet/Planet_Grids', layer = "Bokspits_2_Planet_grid")


#---4.. Extract data for Bokspits_2 Grid


Bokspits_2_WV2_Extract <- exact_extract(Bokspits_2_Predict,Bokspits_2_Planet_grid_SF,"mode")
names(Bokspits_2_WV2_Extract) <- c('mode')
Bokspits_2_WV2_Extract_DF <-bind_cols(Bokspits_2_Planet_grid_SF,Bokspits_2_WV2_Extract)

Bokspits_2_WV2_Extract <- exact_extract(Bokspits_2_Predict,Bokspits_2_Planet_grid_SF,"majority" )
...
Bokspits_2_WV2_Extract <- exact_extract(Bokspits_2_Predict,Bokspits_2_Planet_grid_SF,"frac" )# calculates fraction cover for each classification value
#a column is added with the FVC for each vegetation type frac1, frac2 etc...
...
## NB You cant use exact extract with SpatVector so re-importing it a a spatial DF
Bokspits_3_Planet_grid_SF <- read_sf(dsn = 'E:/Glenn/Botswana/Satellite_Data/Planet/Planet_Grids', layer = "Bokspits_3_Planet_grid")


#---6. Extract data for Bokspits_3 Grid


Bokspits_3_WV2_Extract <- exact_extract(Bokspits_3_Predict,Bokspits_3_Planet_grid_SF,"mode")
names(Bokspits_3_WV2_Extract) <- c('mode')
Bokspits_3_WV2_Extract_DF <-bind_cols(Bokspits_3_Planet_grid_SF,Bokspits_3_WV2_Extract)

Bokspits_3_WV2_Extract <- exact_extract(Bokspits_3_Predict,Bokspits_3_Planet_grid_SF,"majority" )
...
Bokspits_3_WV2_Extract <- exact_extract(Bokspits_3_Predict,Bokspits_3_Planet_grid_SF,"frac" )# calculates fraction cover for each classification value
#a column is added with the FVC for each vegetation type frac1, frac2 etc...
...
## NB You cant use exact extract with SpatVector so re-importing it a a spatial DF
Struizendam_1_Planet_grid_SF <- read_sf(dsn = 'E:/Glenn/Botswana/Satellite_Data/Planet/Planet_Grids', layer = "Struizendam_1_Planet_grid")


#---8. Extract data for Struizendam_1 Grid


Struizendam_1_WV2_Extract <- exact_extract(Struizendam_1_Predict,Struizendam_1_Planet_grid_SF,"mode")
names(Struizendam_1_WV2_Extract) <- c('mode')
Struizendam_1_WV2_Extract_DF <-bind_cols(Struizendam_1_Planet_grid_SF,Struizendam_1_WV2_Extract)

Struizendam_1_WV2_Extract <- exact_extract(Struizendam_1_Predict,Struizendam_1_Planet_grid_SF,"majority" )
...
Struizendam_1_WV2_Extract <- exact_extract(Struizendam_1_Predict,Struizendam_1_Planet_grid_SF,"frac" )# calculates fraction cover for each classification value
#a column is added with the FVC for each vegetation type frac1, frac2 etc...
...
## NB You cant use exact extract with SpatVector so re-importing it a a spatial DF
Struizendam_2_Planet_grid_SF <- read_sf(dsn = 'E:/Glenn/Botswana/Satellite_Data/Planet/Planet_Grids', layer = "Struizendam_2_Planet_grid")


#---10. Extract data for Struizendam_2 Grid


Struizendam_2_WV2_Extract <- exact_extract(Struizendam_2_Predict,Struizendam_2_Planet_grid_SF,"mode")
names(Struizendam_2_WV2_Extract) <- c('mode')
Struizendam_2_WV2_Extract_DF <-bind_cols(Struizendam_2_Planet_grid_SF,Struizendam_2_WV2_Extract)

Struizendam_2_WV2_Extract <- exact_extract(Struizendam_2_Predict,Struizendam_2_Planet_grid_SF,"majority" )
...
Struizendam_2_WV2_Extract <- exact_extract(Struizendam_2_Predict,Struizendam_2_Planet_grid_SF,"frac" )# calculates fraction cover for each classification value
#a column is added with the FVC for each vegetation type frac1, frac2 etc...
...
## NB You cant use exact extract with SpatVector so re-importing it a a spatial DF
Struizendam_3_Planet_grid_SF <- read_sf(dsn = 'E:/Glenn/Botswana/Satellite_Data/Planet/Planet_Grids', layer = "Struizendam_3_Planet_grid")


#---12. Extract data for Struizendam_3 Grid


Struizendam_3_WV2_Extract <- exact_extract(Struizendam_3_Predict,Struizendam_3_Planet_grid_SF,"mode")
names(Struizendam_3_WV2_Extract) <- c('mode')
Struizendam_3_WV2_Extract_DF <-bind_cols(Struizendam_3_Planet_grid_SF,Struizendam_3_WV2_Extract)

Struizendam_3_WV2_Extract <- exact_extract(Struizendam_3_Predict,Struizendam_3_Planet_grid_SF,"majority" )
...
Struizendam_3_WV2_Extract <- exact_extract(Struizendam_3_Predict,Struizendam_3_Planet_grid_SF,"frac" )# calculates fraction cover for each classification value
#a column is added with the FVC for each vegetation type frac1, frac2 etc...
...
## NB You cant use exact extract with SpatVector so re-importing it a a spatial DF
Struizendam_4_Planet_grid_SF <- read_sf(dsn = 'E:/Glenn/Botswana/Satellite_Data/Planet/Planet_Grids', layer = "Struizendam_4_Planet_grid")


#---14. Extract data for Struizendam_4 Grid


Struizendam_4_WV2_Extract <- exact_extract(Struizendam_4_Predict,Struizendam_4_Planet_grid_SF,"mode")
names(Struizendam_4_WV2_Extract) <- c('mode')
Struizendam_4_WV2_Extract_DF <-bind_cols(Struizendam_4_Planet_grid_SF,Struizendam_4_WV2_Extract)

Struizendam_4_WV2_Extract <- exact_extract(Struizendam_4_Predict,Struizendam_4_Planet_grid_SF,"majority" )
...
Struizendam_4_WV2_Extract <- exact_extract(Struizendam_4_Predict,Struizendam_4_Planet_grid_SF,"frac" )# calculates fraction cover for each classification value
#a column is added with the FVC for each vegetation type frac1, frac2 etc...
...
WV2_full_Extract_DF_95_1 <- WV2_full_Extract_DF_95 %>% filter (frac_1 > 0.85)
WV2_full_Extract_DF_95_2 <- WV2_full_Extract_DF_95 %>% filter (frac_2 > 0.85)
WV2_full_Extract_DF_95_3 <- WV2_full_Extract_DF_95 %>% filter (frac_3 > 0.85)
WV2_full_Extract_DF_95_5 <- WV2_full_Extract_DF_95 %>% filter (frac_5 > 0.85)
WV2_full_Extract_DF_95_6 <- WV2_full_Extract_DF_95 %>% filter (frac_6 > 0.85)
WV2_full_Extract_DF_95_7 <- WV2_full_Extract_DF_95 %>% filter (frac_7 > 0.85)
WV2_full_Extract_DF_95_10 <- WV2_full_Extract_DF_95 %>% filter (frac_10 > 0.85)
...
saveRDS(WV2_full_train, "E:/Glenn/Botswana/R_Scripts/Glenn-Prosopis-ML/data_in/Planet_pixel_extract_full_train_85.rds")
st_write(WV2_full_train, dsn = "E:/Glenn/Botswana/R_Scripts/Glenn-Prosopis-ML/data_in/Planet_pixel_extract_full_train_85_V2.shp")
...
WV2_full_Extract_DF_95_6e <-WV2_full_Extract_DF_95_6[ sample( which( WV2_full_Extract_DF_95_6$majority == "6" ) ,270 ), ]
WV2_full_Extract_DF_95_7e <-WV2_full_Extract_DF_95_7[ sample( which( WV2_full_Extract_DF_95_7$majority == "7" ) ,47) , ]
...
saveRDS(WV2_full_traine, "E:/Glenn/Botswana/R_Scripts/Glenn-Prosopis-ML/data_in/Planet_equal_class_size_270_train.rds")
st_write(WV2_full_traine, dsn = "E:/Glenn/Botswana/R_Scripts/Glenn-Prosopis-ML/data_in/Planet_equal_class_size_270_train_V2.shp")
...
# 
# WV2_full_Extract_DF_HD <-WV2_full_Extract_DF_HD[ sample( which( WV2_full_Extract_DF_HD$majority == "21" ) , 280), ]
# 
# 
...
# 
# WV2_full_Extract_DF_MD <-WV2_full_Extract_DF_MD[ sample( which( WV2_full_Extract_DF_MD$majority == "31" ) , 280 ), ]
# 
# 
...
# 
# WV2_full_Extract_DF_LD <-WV2_full_Extract_DF_LD[ sample( which( WV2_full_Extract_DF_LD$majority == "41" ) , 280 ), ]
# 
...
# 
# saveRDS(WV2_full_train_M, "E:/Glenn/Botswana/R_Scripts/Glenn-Prosopis-ML/data_in/WV2_equal_class_size_280_train_and_mixed.rds")
# 
# st_write(WV2_full_train_M, dsn = "E:/Glenn/Botswana/R_Scripts/Glenn-Prosopis-ML/data_in/WV2_equal_class_size_280_train_and_mixed.shp")
# 
# 
# 
# #additional scripts not needed here
# # extracts EVI trend from landsat data
# Bokspits_1_WV2_Extract <- exact_extract(EVI,Bokspits_1_Planet_grid_SF,"mean" )
...
# write_sf(Bokspits_1_WV2_classes_95,"E:/Glenn/Botswana/Satellite_Data/WV2/Training_Data/Bokspits_1_Planet_grid_95.shp" )
# 
# # script if training and validation separation required
# #Bokspits_1_Planet_grid__95_train <- Bokspits_1_WV2_classes_95 %>% dplyr::sample_frac(0.70)
# #a<- as(Bokspits_1_Planet_grid__95_train, 'Spatial')
# #b<- as(Bokspits_1_WV2_classes_95, 'Spatial')
# # sf::st_difference() # Hughs suggestion for an improvment on symdif
# #Bokspits_1_Planet_grid_95_val <- symdif(a,b)
# #Bokspits_1_Planet_grid_95_val <- st_as_sf(Bokspits_1_Planet_grid_95_val)
# #write_sf(Bokspits_1_Planet_grid__95_train,"E:/Glenn/Botswana/Satellite_Data/WV2/Training_Data/Train/Bokspits_1_Planet_grid_95_train.shp" )
# #write_sf(Bokspits_1_Planet_grid_95_val,"E:/Glenn/Botswana/Satellite_Data/WV2/Training_Data/Val/Bokspits_1_Planet_grid_95_val.shp" )
# 
...
# write_sf(Bokspits_1_WV2_classes_85,"E:/Glenn/Botswana/Satellite_Data/WV2/Training_Data/Bokspits_1_Planet_grid_85.shp" )
# 
...
# write_sf(Bokspits_1_WV2_classes_75,"E:/Glenn/Botswana/Satellite_Data/WV2/Training_Data/Bokspits_1_Planet_grid_75.shp" )
# 
...
# write_sf(Bokspits_1_WV2_FVC,"E:/Glenn/Botswana/Satellite_Data/WV2/Training_Data/Bokspits_1_Planet_grid_FVC.shp" )
# 
# 
# #shape file with majority class - all data - to be used with majority class as training layer
# 
# write_sf(Bokspits_1_WV2_Extract_DF,"E:/Glenn/Botswana/Satellite_Data/WV2/Training_Data/Bokspits_1_Planet_grid_All.shp" )
# 
# 
# #Bokspits_1_Planet_grid_All_val  <- dplyr::anti_join(a,b, by = 'id')
# 
# 
# 
# 
