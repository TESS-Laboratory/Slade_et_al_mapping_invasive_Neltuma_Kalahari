...
Confusion1 <- read.csv("E:/Glenn/Botswana/RF/Python/Bokspits_2/Bokspits_2_RF_CHM_conf_matrix.csv")
Base_results <- read.csv("E:/Glenn/Botswana/RF/Python/Bokspits_2/Bokspits_2_RF_CHM_Summary.txt", header = FALSE)
Importance <- read.csv("E:/Glenn/Botswana/RF/Python/Bokspits_2/Bokspits_2_RF_CHM_Importance.txt")
...
Confusion3 <- Confusion4[-c(9),]#removes the last totals row
