...
Confusion1 <- read.csv("E:/Glenn/Botswana/RF/Python/Struizendam_3/Struizendam_3_RF_CHM_conf_matrix.csv")
Base_results <- read.csv("E:/Glenn/Botswana/RF/Python/Struizendam_3/Struizendam_3_RF_CHM_Summary.txt", header = FALSE)
Importance <- read.csv("E:/Glenn/Botswana/RF/Python/Struizendam_3/Struizendam_3_RF_CHM_Importance.txt")
