...
```{r}
Confusion1 <- read.csv("E:/Glenn/Botswana/RF/Python/Struizendam_4/Struizendam_4_RF_conf_matrix.csv")
Base_results <- read.csv("E:/Glenn/Botswana/RF/Python/Struizendam_4/Struizendam_4_RF_Summary.txt", header = FALSE)
Importance <- read.csv("E:/Glenn/Botswana/RF/Python/Struizendam_4/Struizendam_4_RF_Importance.txt")
