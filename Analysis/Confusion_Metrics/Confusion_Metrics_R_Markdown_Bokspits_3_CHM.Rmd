...
## 5 Bands plus Canopy Height Model
...
Confusion1 <- read.csv("E:/Glenn/Botswana/RF/Python/Bokspits_3/Bokspits_3_RF_CHM_conf_matrix.csv")
Base_results <- read.csv("E:/Glenn/Botswana/RF/Python/Bokspits_3/Bokspits_3_RF_CHM_Summary.txt", header = FALSE)
Importance <- read.csv("E:/Glenn/Botswana/RF/Python/Bokspits_3/Bokspits_3_RF_CHM_Importance.txt")
...
Confusion3 <- Confusion4[-c(8),]#removes the last totals row
...
The Standard Precision, Recall F1 Score and Kappa calculations for the Random forest Classification are:
```{r}
print (Base_results)
print (Confusion1)
print (Confusion4)
