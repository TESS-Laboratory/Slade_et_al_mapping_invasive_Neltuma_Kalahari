...
```{r}
Confusion1 <- read.csv("E:/Glenn/Botswana/RF/Python/Bokspits_3/Bokspits_3_RF_conf_matrix.csv")
Base_results <- read.csv("E:/Glenn/Botswana/RF/Python/Bokspits_3/Bokspits_3_RF_Summary.txt", header = FALSE)
Importance <- read.csv("E:/Glenn/Botswana/RF/Python/Bokspits_3/Bokspits_3_RF_Importance.txt")
