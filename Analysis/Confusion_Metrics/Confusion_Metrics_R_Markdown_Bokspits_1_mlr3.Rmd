...
Confusion1 <- read.csv("E:/Glenn/Botswana/R_Scripts/Glenn-Prosopis-Ml/Data/res.preds_svm_stack5_NDVI.csv")
#Base_results <- read.csv("E:/Glenn/Botswana/RF/Python/Bokspits_1/Bokspits_1_RF_CHM_Summary.txt", header = FALSE)
#Importance <- read.csv("E:/Glenn/Botswana/RF/Python/Bokspits_1/Bokspits_1_RF_CHM_Importance.txt")
...
Confusion2 <- as.matrix(Confusion1) #converts table into matrix
