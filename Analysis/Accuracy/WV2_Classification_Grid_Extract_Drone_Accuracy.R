...
B1_Predict_Extract <- exact_extract(WV2_Predict,B1_Grid_SF,"majority" )
names(B1_Predict_Extract) <- c('WV2')
B1_Predict_Extract_DF <- dplyr::mutate(B1_Predict_Extract_DF, WV2 = B1_Predict_Extract)
...
B2_Predict_Extract <- exact_extract(WV2_Predict,B2_Grid_SF,"majority" )
names(B2_Predict_Extract) <- c('WV2')
B2_Predict_Extract_DF <- dplyr::mutate(B2_Predict_Extract_DF, WV2 = B2_Predict_Extract)
...
B3_Predict_Extract <- exact_extract(WV2_Predict,B3_Grid_SF,"majority" )
names(B3_Predict_Extract) <- c('WV2')
B3_Predict_Extract_DF <- dplyr::mutate(B3_Predict_Extract_DF, WV2 = B3_Predict_Extract)
...
S1_Predict_Extract <- exact_extract(WV2_Predict,S1_Grid_SF,"majority" )
names(S1_Predict_Extract) <- c('WV2')
S1_Predict_Extract_DF <- dplyr::mutate(S1_Predict_Extract_DF, WV2 = S1_Predict_Extract)
...
S2_Predict_Extract <- exact_extract(WV2_Predict,S2_Grid_SF,"majority" )
names(S2_Predict_Extract) <- c('WV2')
S2_Predict_Extract_DF <- dplyr::mutate(S2_Predict_Extract_DF, WV2 = S2_Predict_Extract)
...
S3_Predict_Extract <- exact_extract(WV2_Predict,S3_Grid_SF,"majority" )
names(S3_Predict_Extract) <- c('WV2')
S3_Predict_Extract_DF <- dplyr::mutate(S3_Predict_Extract_DF, WV2 = S3_Predict_Extract)
...
S4_Predict_Extract <- exact_extract(WV2_Predict,S4_Grid_SF,"majority" )
names(S4_Predict_Extract) <- c('WV2')
S4_Predict_Extract_DF <- dplyr::mutate(S4_Predict_Extract_DF, WV2 = S4_Predict_Extract)
...
Full_WV2 <- rbind(B1_Predict_Extract_DF,B2_Predict_Extract_DF,B3_Predict_Extract_DF,S1_Predict_Extract_DF,S2_Predict_Extract_DF,S3_Predict_Extract_DF,S4_Predict_Extract_DF)



write.xlsx(Full_WV2, "E:/Glenn/Botswana/R_Scripts/Glenn-Prosopis-ML/data_out/Drone_extract_accuracy_assesment.xlsx")
...
ggsave(
  ...
  filename = "output_data/WV2 accuracy comparison with drone.png",
  width = 16,
  height = 10,
  units = "cm"
)
