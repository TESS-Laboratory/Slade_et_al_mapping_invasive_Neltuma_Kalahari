...
p2 <- ggplot(aes(x=factor(S2)), data = Prospis_predict3)+ geom_bar(stat = "count")+ 
  scale_x_discrete(labels=c("1" = "Prosopis", "2"="BG", "3" = "Grass", "4" = "F","5" = "VE","6" = "RT","7" = "OW"))+
    xlab("Class")+ ylab("Number of pixels")+theme_fancy()
...
ggsave(
  ...
  filename = "output_data/S2 accuracy comparison with drone.png",
  width = 16,
  height = 10,
  units = "cm"
)
...
B1_Predict_Extract <- B1_Predict_Extract%>% dplyr::select (frac_1)
B1_Predict_Extract_DF <- bind_cols(B1, B1_Drone = B1_Predict_Extract )

B1_Predict_Extract <- exact_extract(WV2_Predict,B1,"frac" )
B1_Predict_Extract <- B1_Predict_Extract%>% dplyr::select (frac_1)
B1_Predict_Extract_DF <- dplyr::mutate(B1_Predict_Extract_DF, B1_WV2 = B1_Predict_Extract)

B1_Predict_Extract <- exact_extract(Sen2_Predict,B1,"frac" )
B1_Predict_Extract <- B1_Predict_Extract%>% dplyr::select (frac_1)
B1_Predict_Extract_DF <- dplyr::mutate(B1_Predict_Extract_DF, B1_Sen2 = B1_Predict_Extract)

B1_Predict_Extract <- exact_extract(Planet_Predict,B1,"frac" )
B1_Predict_Extract <- B1_Predict_Extract%>% dplyr::select (frac_1)
B1_Predict_Extract_DF <- dplyr::mutate(B1_Predict_Extract_DF, B1_Planet = B1_Predict_Extract)

B1_Predict_Extract <- exact_extract(LS8_Predict,B1,"frac" )
B1_Predict_Extract <- B1_Predict_Extract%>% dplyr::select (frac_1)
B1_Predict_Extract_DF <- dplyr::mutate(B1_Predict_Extract_DF, B1_LS8 = B1_Predict_Extract)

B1_Predict_Extract <- exact_extract(LS8_Time_Predict,B1,"frac" )
B1_Predict_Extract <- B1_Predict_Extract%>% dplyr::select (frac_1)
B1_Predict_Extract_DF <- dplyr::mutate(B1_Predict_Extract_DF, B1_LS8T = B1_Predict_Extract)

#B2
B2_Predict_Extract <- exact_extract(B2_Predict,B2,"frac" )
B2_Predict_Extract <- B2_Predict_Extract%>% dplyr::select (frac_1)
B2_Predict_Extract_DF <- bind_cols(B2, B2_Drone = B2_Predict_Extract )

B2_Predict_Extract <- exact_extract(WV2_Predict,B2,"frac" )
B2_Predict_Extract <- B2_Predict_Extract%>% dplyr::select (frac_1)
B2_Predict_Extract_DF <- dplyr::mutate(B2_Predict_Extract_DF, B2_WV2 = B2_Predict_Extract)

B2_Predict_Extract <- exact_extract(Sen2_Predict,B2,"frac" )
B2_Predict_Extract <- B2_Predict_Extract%>% dplyr::select (frac_1)
B2_Predict_Extract_DF <- dplyr::mutate(B2_Predict_Extract_DF, B2_Sen2 = B2_Predict_Extract)

B2_Predict_Extract <- exact_extract(Planet_Predict,B2,"frac" )
B2_Predict_Extract <- B2_Predict_Extract%>% dplyr::select (frac_1)
B2_Predict_Extract_DF <- dplyr::mutate(B2_Predict_Extract_DF, B2_Planet = B2_Predict_Extract)

B2_Predict_Extract <- exact_extract(LS8_Predict,B2,"frac" )
B2_Predict_Extract <- B2_Predict_Extract%>% dplyr::select (frac_1)
B2_Predict_Extract_DF <- dplyr::mutate(B2_Predict_Extract_DF, B2_LS8 = B2_Predict_Extract)

B2_Predict_Extract <- exact_extract(LS8_Time_Predict,B2,"frac" )
B2_Predict_Extract <- B2_Predict_Extract%>% dplyr::select (frac_1)
B2_Predict_Extract_DF <- dplyr::mutate(B2_Predict_Extract_DF, B2_LS8T = B2_Predict_Extract)

#B3
B3_Predict_Extract <- exact_extract(B3_Predict,B3,"frac" )
B3_Predict_Extract <- B3_Predict_Extract%>% dplyr::select (frac_1)
B3_Predict_Extract_DF <- bind_cols(B3, B3_Drone = B3_Predict_Extract )

B3_Predict_Extract <- exact_extract(WV2_Predict,B3,"frac" )
B3_Predict_Extract <- B3_Predict_Extract%>% dplyr::select (frac_1)
B3_Predict_Extract_DF <- dplyr::mutate(B3_Predict_Extract_DF, B3_WV2 = B3_Predict_Extract)

B3_Predict_Extract <- exact_extract(Sen2_Predict,B3,"frac" )
B3_Predict_Extract <- B3_Predict_Extract%>% dplyr::select (frac_1)
B3_Predict_Extract_DF <- dplyr::mutate(B3_Predict_Extract_DF, B3_Sen2 = B3_Predict_Extract)

B3_Predict_Extract <- exact_extract(Planet_Predict,B3,"frac" )
B3_Predict_Extract <- B3_Predict_Extract%>% dplyr::select (frac_1)
B3_Predict_Extract_DF <- dplyr::mutate(B3_Predict_Extract_DF, B3_Planet = B3_Predict_Extract)

B3_Predict_Extract <- exact_extract(LS8_Predict,B3,"frac" )
B3_Predict_Extract <- B3_Predict_Extract%>% dplyr::select (frac_1)
B3_Predict_Extract_DF <- dplyr::mutate(B3_Predict_Extract_DF, B3_LS8 = B3_Predict_Extract)

B3_Predict_Extract <- exact_extract(LS8_Time_Predict,B3,"frac" )
B3_Predict_Extract <- B3_Predict_Extract%>% dplyr::select (frac_1)
B3_Predict_Extract_DF <- dplyr::mutate(B3_Predict_Extract_DF, B3_LS8T = B3_Predict_Extract)
#S1
S1_Predict_Extract <- exact_extract(S1_Predict,S1,"frac" )
S1_Predict_Extract <- S1_Predict_Extract%>% dplyr::select (frac_1)
S1_Predict_Extract_DF <- bind_cols(S1, S1_Drone = S1_Predict_Extract )

S1_Predict_Extract <- exact_extract(WV2_Predict,S1,"frac" )
S1_Predict_Extract <- S1_Predict_Extract%>% dplyr::select (frac_1)
S1_Predict_Extract_DF <- dplyr::mutate(S1_Predict_Extract_DF, S1_WV2 = S1_Predict_Extract)

S1_Predict_Extract <- exact_extract(Sen2_Predict,S1,"frac" )
S1_Predict_Extract <- S1_Predict_Extract%>% dplyr::select (frac_1)
S1_Predict_Extract_DF <- dplyr::mutate(S1_Predict_Extract_DF, S1_Sen2 = S1_Predict_Extract)

S1_Predict_Extract <- exact_extract(Planet_Predict,S1,"frac" )
S1_Predict_Extract <- S1_Predict_Extract%>% dplyr::select (frac_1)
S1_Predict_Extract_DF <- dplyr::mutate(S1_Predict_Extract_DF, S1_Planet = S1_Predict_Extract)

S1_Predict_Extract <- exact_extract(LS8_Predict,S1,"frac" )
S1_Predict_Extract <- S1_Predict_Extract%>% dplyr::select (frac_1)
S1_Predict_Extract_DF <- dplyr::mutate(S1_Predict_Extract_DF, S1_LS8 = S1_Predict_Extract)

S1_Predict_Extract <- exact_extract(LS8_Time_Predict,S1,"frac" )
S1_Predict_Extract <- S1_Predict_Extract%>% dplyr::select (frac_1)
S1_Predict_Extract_DF <- dplyr::mutate(S1_Predict_Extract_DF, S1_LS8T = S1_Predict_Extract)
#S2
S2_Predict_Extract <- exact_extract(S2_Predict,S2,"frac" )
S2_Predict_Extract <- S2_Predict_Extract%>% dplyr::select (frac_1)
S2_Predict_Extract_DF <- bind_cols(S2, S2_Drone = S2_Predict_Extract )

S2_Predict_Extract <- exact_extract(WV2_Predict,S2,"frac" )
S2_Predict_Extract <- S2_Predict_Extract%>% dplyr::select (frac_1)
S2_Predict_Extract_DF <- dplyr::mutate(S2_Predict_Extract_DF, S2_WV2 = S2_Predict_Extract)

S2_Predict_Extract <- exact_extract(Sen2_Predict,S2,"frac" )
S2_Predict_Extract <- S2_Predict_Extract%>% dplyr::select (frac_1)
S2_Predict_Extract_DF <- dplyr::mutate(S2_Predict_Extract_DF, S2_Sen2 = S2_Predict_Extract)

S2_Predict_Extract <- exact_extract(Planet_Predict,S2,"frac" )
S2_Predict_Extract <- S2_Predict_Extract%>% dplyr::select (frac_1)
S2_Predict_Extract_DF <- dplyr::mutate(S2_Predict_Extract_DF, S2_Planet = S2_Predict_Extract)

S2_Predict_Extract <- exact_extract(LS8_Predict,S2,"frac" )
S2_Predict_Extract <- S2_Predict_Extract%>% dplyr::select (frac_1)
S2_Predict_Extract_DF <- dplyr::mutate(S2_Predict_Extract_DF, S2_LS8 = S2_Predict_Extract)

S2_Predict_Extract <- exact_extract(LS8_Time_Predict,S2,"frac" )
S2_Predict_Extract <- S2_Predict_Extract%>% dplyr::select (frac_1)
S2_Predict_Extract_DF <- dplyr::mutate(S2_Predict_Extract_DF, S2_LS8T = S2_Predict_Extract)

#S3

S3_Predict_Extract <- exact_extract(S3_Predict,S3,"frac" )
S3_Predict_Extract <- S3_Predict_Extract%>% dplyr::select (frac_1)
S3_Predict_Extract_DF <- bind_cols(S3, S3_Drone = S3_Predict_Extract )

S3_Predict_Extract <- exact_extract(WV2_Predict,S3,"frac" )
S3_Predict_Extract <- S3_Predict_Extract%>% dplyr::select (frac_1)
S3_Predict_Extract_DF <- dplyr::mutate(S3_Predict_Extract_DF, S3_WV2 = S3_Predict_Extract)

S3_Predict_Extract <- exact_extract(Sen2_Predict,S3,"frac" )
S3_Predict_Extract <- S3_Predict_Extract%>% dplyr::select (frac_1)
S3_Predict_Extract_DF <- dplyr::mutate(S3_Predict_Extract_DF, S3_Sen2 = S3_Predict_Extract)

S3_Predict_Extract <- exact_extract(Planet_Predict,S3,"frac" )
S3_Predict_Extract <- S3_Predict_Extract%>% dplyr::select (frac_1)
S3_Predict_Extract_DF <- dplyr::mutate(S3_Predict_Extract_DF, S3_Planet = S3_Predict_Extract)

S3_Predict_Extract <- exact_extract(LS8_Predict,S3,"frac" )
S3_Predict_Extract <- S3_Predict_Extract%>% dplyr::select (frac_1)
S3_Predict_Extract_DF <- dplyr::mutate(S3_Predict_Extract_DF, S3_LS8 = S3_Predict_Extract)

S3_Predict_Extract <- exact_extract(LS8_Time_Predict,S3,"frac" )
S3_Predict_Extract <- S3_Predict_Extract%>% dplyr::select (frac_1)
S3_Predict_Extract_DF <- dplyr::mutate(S3_Predict_Extract_DF, S3_LS8T = S3_Predict_Extract)

#S4

S4_Predict_Extract <- exact_extract(S4_Predict,S4,"frac" )
S4_Predict_Extract <- S4_Predict_Extract%>% dplyr::select (frac_1)
S4_Predict_Extract_DF <- bind_cols(S4, S4_Drone = S4_Predict_Extract )

S4_Predict_Extract <- exact_extract(WV2_Predict,S4,"frac" )
S4_Predict_Extract <- S4_Predict_Extract%>% dplyr::select (frac_1)
S4_Predict_Extract_DF <- dplyr::mutate(S4_Predict_Extract_DF, S4_WV2 = S4_Predict_Extract)

S4_Predict_Extract <- exact_extract(Sen2_Predict,S4,"frac" )
S4_Predict_Extract <- S4_Predict_Extract%>% dplyr::select (frac_1)
S4_Predict_Extract_DF <- dplyr::mutate(S4_Predict_Extract_DF, S4_Sen2 = S4_Predict_Extract)

S4_Predict_Extract <- exact_extract(Planet_Predict,S4,"frac" )
S4_Predict_Extract <- S4_Predict_Extract%>% dplyr::select (frac_1)
S4_Predict_Extract_DF <- dplyr::mutate(S4_Predict_Extract_DF, S4_Planet = S4_Predict_Extract)

S4_Predict_Extract <- exact_extract(LS8_Predict,S4,"frac" )
S4_Predict_Extract <- S4_Predict_Extract%>% dplyr::select (frac_1)
S4_Predict_Extract_DF <- dplyr::mutate(S4_Predict_Extract_DF, S4_LS8 = S4_Predict_Extract)

S4_Predict_Extract <- exact_extract(LS8_Time_Predict,S4,"frac" )
S4_Predict_Extract <- S4_Predict_Extract%>% dplyr::select (frac_1)
S4_Predict_Extract_DF <- dplyr::mutate(S4_Predict_Extract_DF, S4_LS8T = S4_Predict_Extract)
