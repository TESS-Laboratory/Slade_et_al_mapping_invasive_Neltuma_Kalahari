...
saveRDS(WV2_full_train, "/data_in/WV2/WV2_pixel_extract_full_train_95.rds")
st_write(WV2_full_train, "/data_in/WV2/WV2_pixel_extract_full_train_95.shp", append=FALSE)
...
saveRDS(WV2_full_traine, "/data_in/WV2/WV2_equal_class_size_500_train_95.rds")
st_write(WV2_full_traine, "/data_in/WV2/WV2_equal_class_size_500_train_95.shp", append=FALSE)
