...
Bokspits_1_Predict <- rast("E:/Glenn/Botswana/R_Scripts/Glenn-Prosopis-ML/data_out/Bokspits_1/Bokspits_1_Predict_Map.tif")
Bokspits_1_Predict
...
Bokspits_2_Predict <- rast("E:/Glenn/Botswana/R_Scripts/Glenn-Prosopis-ML/data_out/Bokspits_2/Bokspits_2_Predict_Map.tif")
...
Bokspits_3_Predict <- rast("E:/Glenn/Botswana/R_Scripts/Glenn-Prosopis-ML/data_out/Bokspits_3/Bokspits_3_Predict_Map.tif")
...
Struizendam_1_Predict <- rast("E:/Glenn/Botswana/R_Scripts/Glenn-Prosopis-ML/data_out/Struizendam_1/Struizendam_1_Predict_Map.tif")
...
Struizendam_2_Predict <- rast("E:/Glenn/Botswana/R_Scripts/Glenn-Prosopis-ML/data_out/Struizendam_2/Struizendam_2_Predict_Map.tif")
...
Struizendam_3_Predict <- rast("E:/Glenn/Botswana/R_Scripts/Glenn-Prosopis-ML/data_out/Struizendam_3/Struizendam_3_Predict_Map.tif")
...
Struizendam_4_Predict <- rast("E:/Glenn/Botswana/R_Scripts/Glenn-Prosopis-ML/data_out/Struizendam_4/Struizendam_4_Predict_Map.tif")
...
saveRDS(WV2_full_Extract_DF, "E:/Glenn/Botswana/R_Scripts/Glenn-Prosopis-ML/data_in/WV2/WV2_pixel_extract_full_train_all.rds")
st_write(WV2_full_Extract_DF, "E:/Glenn/Botswana/R_Scripts/Glenn-Prosopis-ML/data_in/WV2/WV2_pixel_extract_full_train_all.shp", append=FALSE)

WV2_full_Extract_DF_95_1 <- WV2_full_Extract_DF %>% filter (frac_1 > 0.95)
WV2_full_Extract_DF_95_2 <- WV2_full_Extract_DF %>% filter (frac_2 > 0.95)
WV2_full_Extract_DF_95_3 <- WV2_full_Extract_DF  %>% filter (frac_3 > 0.95)
WV2_full_Extract_DF_95_5 <- WV2_full_Extract_DF %>% filter (frac_5 > 0.95)
WV2_full_Extract_DF_95_6 <- WV2_full_Extract_DF  %>% filter (frac_6 > 0.95)
WV2_full_Extract_DF_95_7 <- WV2_full_Extract_DF  %>% filter (frac_7 > 0.95)
WV2_full_Extract_DF_95_10 <- WV2_full_Extract_DF %>% filter (frac_10 > 0.95)
...
saveRDS(WV2_full_train, "E:/Glenn/Botswana/R_Scripts/Glenn-Prosopis-ML/data_in/WV2/WV2_pixel_extract_full_train_95.rds")
st_write(WV2_full_train, "E:/Glenn/Botswana/R_Scripts/Glenn-Prosopis-ML/data_in/WV2/WV2_pixel_extract_full_train_95.shp", append=FALSE)
...
WV2_full_Extract_DF_95_1e <-WV2_full_Extract_DF_95_1 [ sample( which( WV2_full_Extract_DF_95_1$Type == "1" ) ,N ) , ]
WV2_full_Extract_DF_95_2e <-WV2_full_Extract_DF_95_2[ sample( which( WV2_full_Extract_DF_95_2$Type == "2" ) ,N) , ]
WV2_full_Extract_DF_95_3e <-WV2_full_Extract_DF_95_3[ sample( which( WV2_full_Extract_DF_95_3$Type == "3" ) ,N) , ]
WV2_full_Extract_DF_95_5e <-WV2_full_Extract_DF_95_5[ sample( which( WV2_full_Extract_DF_95_5$Type == "5" ) , N) , ]
WV2_full_Extract_DF_95_6e <-WV2_full_Extract_DF_95_6[ sample( which( WV2_full_Extract_DF_95_6$Type == "6" ) ,N ), ]
WV2_full_Extract_DF_95_7e <-WV2_full_Extract_DF_95_7[ sample( which( WV2_full_Extract_DF_95_7$Type == "7" ) ,N) , ]
...
WV2_full_traine <- dplyr::select(WV2_full_traine,- frac_0)
...
saveRDS(WV2_full_traine, "E:/Glenn/Botswana/R_Scripts/Glenn-Prosopis-ML/data_in/WV2/WV2_equal_class_size_280_train_95.rds")
st_write(WV2_full_traine, "E:/Glenn/Botswana/R_Scripts/Glenn-Prosopis-ML/data_in/WV2/WV2_equal_class_size_280_train_95.shp", append=FALSE)
...
saveRDS(WV2_full_train_M, "/E:/Glenn/Botswana/R_Scripts/Glenn-Prosopis-ML/data_in/WV2/WV2_equal_class_size_",paste0(N),"_train_and_mixed.rds")

st_write(WV2_full_train_M, dsn = "/E:/Glenn/Botswana/R_Scripts/Glenn-Prosopis-ML/data_in/WV2/WV2_equal_class_size_",paste0(N),"_train_and_mixed.shp")



# making a simplified training set with 4 classes
...
WV2_full_Extract_DF_95_7 <- WV2_full_Extract_DF  %>% filter (frac_7 > 0.95)
WV2_full_Extract_DF_95_10 <- WV2_full_Extract_DF %>% filter (frac_10 > 0.95)
WV2_full_Extract_DF_95_13 <- WV2_full_Extract_DF %>% filter (frac_13 > 0.95)


WV2_full_train <- bind_rows(WV2_full_Extract_DF_95_1,WV2_full_Extract_DF_95_2,WV2_full_Extract_DF_95_3,WV2_full_Extract_DF_95_5,WV2_full_Extract_DF_95_6,WV2_full_Extract_DF_95_7,WV2_full_Extract_DF_95_10,WV2_full_Extract_DF_95_13,)
...
# Sampling the full training set to have equal class size of N
WV2_full_train$Type[WV2_full_train$Type == 4] <- 13
WV2_full_train$Type[WV2_full_train$Type > 4 ] <- 13

WV2_full_Extract_DF_95_1e <-WV2_full_train [ sample( which( WV2_full_train$Type == "1" ) ,N ) , ]
WV2_full_Extract_DF_95_2e <-WV2_full_train[ sample( which( WV2_full_train$Type == "2" ) ,N) , ]
WV2_full_Extract_DF_95_3e <-WV2_full_train[ sample( which( WV2_full_train$Type == "3" ) ,N) , ]
WV2_full_Extract_DF_95_13e <-WV2_full_train[ sample( which(WV2_full_train$Type == "13" ) , N) , ]

WV2_full_traine <- bind_rows(WV2_full_Extract_DF_95_1e,WV2_full_Extract_DF_95_2e,WV2_full_Extract_DF_95_3e,WV2_full_Extract_DF_95_13e)
...
saveRDS(WV2_full_traine, "E:/Glenn/Botswana/R_Scripts/Glenn-Prosopis-ML/data_in/WV2/WV2_equal_class_size_500_train_95_simple.rds")
st_write(WV2_full_traine, "E:/Glenn/Botswana/R_Scripts/Glenn-Prosopis-ML/data_in/WV2/WV2_equal_class_size_500_train_95_simple.shp", append=FALSE)
