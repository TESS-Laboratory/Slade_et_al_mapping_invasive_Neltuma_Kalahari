...
WV2_full_Extract_DF_95_1 <- WV2_full_Extract_DF_95 %>% filter (frac_1 > paste0(P))
WV2_full_Extract_DF_95_2 <- WV2_full_Extract_DF_95 %>% filter (frac_2 > A)
...
saveRDS(WV2_full_train, "E:/Glenn/Botswana/R_Scripts/Glenn-Prosopis-ML/data_in/WV2_pixel_extract_full_train.rds")
st_write(WV2_full_train, dsn = "E:/Glenn/Botswana/R_Scripts/Glenn-Prosopis-ML/data_in/WV2_pixel_extract_full_train.shp")
...
saveRDS(WV2_full_traine, "E:/Glenn/Botswana/R_Scripts/Glenn-Prosopis-ML/data_in/WV2_equal_class_size_280_train.rds")
st_write(WV2_full_traine, dsn = "E:/Glenn/Botswana/R_Scripts/Glenn-Prosopis-ML/data_in/WV2_equal_class_size_280_train.shp")
...
EVI_extract <- exact_extract(EVI,Bokspits_1_WV2_grid_SF,"mean" )
names(EVI_extract) <- c('EVI_Trend')
