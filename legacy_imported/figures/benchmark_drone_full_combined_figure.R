...
#   source path   Manuscript figures/benchmark_drone_full_combined_figure.R
#   ref           main @ 671e56f
#   sha256        c7c81b94cc4d955257653906ba974738b7d4c681f01691e91ee52bd29a3e0433
#
#   why           Figure 4 (A/B/C). NEWER than the published Analysis/Benchmark_Analysis copy: writes _v4 not _v2 and adds geom_jitter on the learner panel. Treat this as canonical.
#
...
ggplot2::ggsave(
  P_All3,
  # filename = "/plots/test.png",
  filename = paste0("output_data/Manuscript figures/Combined_drone_accuracy_figure_v4.jpg"),
  width = 16,
  height = 8,
  units = "cm"
) 
