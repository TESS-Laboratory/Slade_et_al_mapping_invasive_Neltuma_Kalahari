...
#   source path   Profile_Plots.R
#   ref           main @ 671e56f
#   sha256        33b2cbe82495fc75790597ddef64cce00b26c6755123018f2aa3de988f0b62a5
#
#   why           Distance-to-settlement / distance-to-road profiles, Figs S10 and S11.
#
...
DRONE <- read.table("E:/Glenn/Botswana/Analysis/Profile_lines/Profile_1_Drone.txt",sep='\t', header=TRUE)
PLANET <- read.table("E:/Glenn/Botswana/Analysis/Profile_lines//Profile_1_Planet.txt",sep='\t',header=TRUE)
...
ggsave2(
  P2,
  filename = "E:/Glenn/Botswana/R_Scripts/slade-prosopis/output_data/plots/Profile_1_Drone_vs_Planet_NDVI.jpg",
  width =16,
  height = 8,
  units = "cm"
)
...
ggsave2(
  P4,
  filename = "E:/Glenn/Botswana/R_Scripts/slade-prosopis/output_data/plots/Profile_1_Drone_vs_Planet_MSAVI.jpg",
  width =16,
  height = 8,
  units = "cm"
)
