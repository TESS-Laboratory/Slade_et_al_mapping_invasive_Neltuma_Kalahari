...
list(
  ...
  tar_target_raw("fig_cover_grain",
    rlang::call2("make_fig_cover_grain",
      ...
      di_paths = rlang::call2("list",
        wv2 = rlang::call2("[", quote(cover_di_raster_wv2), 1L),
        planet = rlang::call2("[", quote(cover_di_raster_planet), 1L),
        s2 = rlang::call2("[", quote(cover_di_raster_s2), 1L)),
      thresholds = rlang::call2("list",
        wv2 = quote(cover_threshold_wv2), planet = quote(cover_threshold_planet), s2 = quote(cover_threshold_s2)),
      oofs = rlang::call2("list",
        wv2 = quote(cover_oof_wv2), planet = quote(cover_oof_planet), s2 = quote(cover_oof_s2)),
      di_objs = rlang::call2("list",
        wv2 = quote(cover_di_wv2), planet = quote(cover_di_planet), s2 = quote(cover_di_s2)),
      aoi = quote(wv2_aoi),
  ...
  tar_target_raw("fig_cover_full",
    rlang::call2("make_fig_cover_full",
      cover_paths = rlang::call2("list",
        wv2 = rlang::call2("[", quote(cover_scene_wv2), 1L),
        planet = rlang::call2("[", quote(cover_scene_planet), 1L),
        s2 = rlang::call2("[", quote(cover_scene_s2), 1L)),
